...
static void test_p101_pthread_cond_broadcast(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_cond_destroy(&native_argument_2);
...
static void test_p101_pthread_cond_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_cond_destroy(&native_argument_2);
            (void)pthread_condattr_destroy(&native_argument_3);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_cond_timedwait(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)pthread_cond_destroy(&native_argument_2);
            (void)pthread_mutex_destroy(&native_argument_3);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_condattr_getpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_condattr_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_condattr_setpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_pthread_condattr_setpshared(native_env, native_err, &native_argument_2, 0);
            (void)native_result;
            (void)pthread_condattr_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
...
static void test_p101_pthread_mutex_getprioceiling(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_mutex_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_mutex_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_mutex_destroy(&native_argument_2);
            (void)pthread_mutexattr_destroy(&native_argument_3);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_mutexattr_getprioceiling(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_mutexattr_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_mutexattr_setpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_pthread_mutexattr_setpshared(native_env, native_err, &native_argument_2, 0);
            (void)native_result;
            (void)pthread_mutexattr_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
...
static void test_p101_pthread_rwlock_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_rwlock_destroy(&native_argument_2);
            (void)pthread_rwlockattr_destroy(&native_argument_3);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_rwlockattr_getpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            (void)native_result;
            (void)pthread_rwlockattr_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
        }
...
static void test_p101_pthread_rwlockattr_setpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_pthread_rwlockattr_setpshared(native_env, native_err, &native_argument_2, 0);
            (void)native_result;
            (void)pthread_rwlockattr_destroy(&native_argument_2);
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
...
static void test_p101_sem_open(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            sem_t *native_result = p101_sem_open(native_env, native_err, "p101", 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_sem_unlink(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_sem_unlink(native_env, native_err, "p101");
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
