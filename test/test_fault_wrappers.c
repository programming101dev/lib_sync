...
static void test_p101_pthread_cond_broadcast(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            {
                fprintf(stderr, "native smoke failed: p101_pthread_cond_broadcast: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_pthread_cond_destroy(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_cond_destroy: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_pthread_cond_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_cond_init: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result == 0)
            {
...
static void test_p101_pthread_cond_signal(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_cond_signal: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_cond_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_cond_timedwait(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_cond_timedwait: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_pthread_cond_wait(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_cond_wait: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_pthread_condattr_destroy(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_condattr_destroy: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_pthread_condattr_getpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_condattr_getpshared: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_condattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_condattr_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_condattr_init: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result == 0)
            {
...
static void test_p101_pthread_condattr_setpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_condattr_setpshared: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_condattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutex_destroy(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_destroy: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_pthread_mutex_getprioceiling(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_getprioceiling: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutex_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutex_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_init: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result == 0)
            {
...
static void test_p101_pthread_mutex_lock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_lock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_pthread_mutex_setprioceiling(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_setprioceiling: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutex_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutex_trylock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_trylock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutex_unlock(&native_argument_2));
            P101_NATIVE_CLEANUP_STATUS(pthread_mutex_destroy(&native_argument_2));
...
static void test_p101_pthread_mutex_unlock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutex_unlock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutex_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_destroy(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_destroy: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_pthread_mutexattr_getprioceiling(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_getprioceiling: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_getprotocol(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_getprotocol: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_getpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_getpshared: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_gettype(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_gettype: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_init: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result == 0)
            {
...
static void test_p101_pthread_mutexattr_setprioceiling(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_setprioceiling: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_setprotocol(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_setprotocol: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_setpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_setpshared: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_mutexattr_settype(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_mutexattr_settype: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_mutexattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_once(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_once: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
        native_child_done_:
...
static void test_p101_pthread_rwlock_destroy(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_destroy: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_pthread_rwlock_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_init: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result == 0)
            {
...
static void test_p101_pthread_rwlock_rdlock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_rdlock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_pthread_rwlock_tryrdlock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_tryrdlock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_unlock(&native_argument_2));
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_destroy(&native_argument_2));
...
static void test_p101_pthread_rwlock_trywrlock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_trywrlock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_unlock(&native_argument_2));
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_destroy(&native_argument_2));
...
static void test_p101_pthread_rwlock_unlock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_unlock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_rwlock_wrlock(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlock_wrlock: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_unlock(&native_argument_2));
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlock_destroy(&native_argument_2));
...
static void test_p101_pthread_rwlockattr_destroy(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlockattr_destroy: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_pthread_rwlockattr_getpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlockattr_getpshared: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlockattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_pthread_rwlockattr_init(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlockattr_init: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result == 0)
            {
...
static void test_p101_pthread_rwlockattr_setpshared(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_pthread_rwlockattr_setpshared: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_STATUS(pthread_rwlockattr_destroy(&native_argument_2));
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
...
static void test_p101_sem_close(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_sem_close: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_sem_open(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_sem_open: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_sem_post(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_sem_post: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_sem_trywait(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_sem_trywait: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_ERRNO(sem_close(native_argument_2));
            P101_NATIVE_CLEANUP_ERRNO(sem_unlink(native_argument_2_name));
...
static void test_p101_sem_unlink(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_sem_unlink: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            if(native_result != 0)
            {
...
static void test_p101_sem_wait(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_sem_wait: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            P101_NATIVE_CLEANUP_ERRNO(sem_close(native_argument_2));
            P101_NATIVE_CLEANUP_ERRNO(sem_unlink(native_argument_2_name));
